    ...
    <tr>
        <td class="showPanelBg" valign="top" width="100%">
            <div class="small" style="padding:20px">
                <span class="lvtHeaderText">{'LBL_TWILIO_SMS'|@getTranslatedString:$MODULE}</span> <br>
                        ...
                        <td>
                            <table class="small" border="0" cellpadding="3" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td class="dvtSelectedCell" nowrap="nowrap" align="center">{'LBL_SEND_SMS'|@getTranslatedString:$MODULE}</td>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="padding:10px">
                                                        <!-- General details -->
                                                        <form name="send_sms" id="webform_edit" action="index.php?module=Twilio&action=Sms&mode=send" method="post">
                                                            ...
                                                            <table   class="small" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td colspan="4" style="padding:5px">
                                                                        <div align="center" >
                                                                            <input title="{'LBL_SEND_SMS'|@getTranslatedString:$MODULE}" accesskey="{'LBL_SEND_SMS'|@getTranslatedString:$MODULE}" class="crmbutton small save"  name="button" value="{'LBL_SEND_SMS'|@getTranslatedString:$MODULE} " style="width:70px" type="submit">
                                                                ...
                                                                <tr>
                                                                    <td colspan="4" class="detailedViewHeader">
                                                                        <b>{'LBL_SMS_INFORMATION'|@getTranslatedString:$MODULE}</b>
                                                                    </td>
                                                                ...
                                                                <tr style="height:25px">
                                                                    <td class="dvtCellLabel" align="right" width="20%" nowrap="nowrap">
                                                                        <font color="red">*</font>{'LBL_SMS_TO'|@getTranslatedString:$MODULE}
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="dvtCellLabel" align="right" colspan="1">
                                                                        {'LBL_SMS_BODY'|@getTranslatedString:$MODULE}
                                                                    </td>
                                                                    <td  colspan="3">
